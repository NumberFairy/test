                            ...
                            <div class="m-t">
                                <form class="form-horizontal" id="form-all">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                             <textarea name="entity.content" class="form-control" rows="4" placeholder="请输入参与人">${entity.content}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript" src="${contentPath}/resources/js/alumni-server-manage/alumni-notice-template/template-create.js"></script>
</html>