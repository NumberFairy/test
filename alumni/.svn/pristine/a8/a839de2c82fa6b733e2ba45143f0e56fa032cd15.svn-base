...
public class BranchRelationAction extends AbstractCrudAction<BaseBranchRelation> {
	private static final long serialVersionUID = 1L;

	public BranchRelationAction(@Qualifier(value = "baseBranchRelationSrv") IBaseSrv<BaseBranchRelation> baseSrv) {
		super(baseSrv);
	}
