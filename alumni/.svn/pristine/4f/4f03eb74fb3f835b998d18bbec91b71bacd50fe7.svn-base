<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <%@include file="/WEB-INF/jsp/common/header.jsp"%>
                                        ...
                                        <div class="clearfix">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="entity.alumni.birthDate" value="${entity.alumni.birthDate}" placeholder="请输入出生日期" class="form-control form_date">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="entity.alumni.enrollYear" value="<s:date name='entity.birthDate' format='yyyy-MM-dd' />" placeholder="请输入" class="form-control form_year">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">
        ...
        <%@ include file="/WEB-INF/jsp/common/js-container.jsp"%>
            ...
            <script type="text/javascript" src="${contentPath}/resources/js/alumni-manage-center/unversity-core-alumni/create.js"></script>
