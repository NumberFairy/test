                        ...
                        <div class="ibox-content">
                           <form class="form-inline clearfix" id="form" role="form">
                                    <div class="form-group marb">
                                        <label class="label-reset">名称 ：</label>
                                        <input placeholder="名称" class="form-control input-reset" name="notice.noticeTitle">
                                    </div>
                                    <div class="form-group marb">
                                        <label class="label-reset">状态  ：</label>
                                        <select class="form-control select-reset" name="notice.status">                                            
