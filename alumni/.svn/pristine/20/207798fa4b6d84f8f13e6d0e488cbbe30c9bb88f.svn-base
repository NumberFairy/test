...
public class CollegeKeyAlumniAction extends AbstractCrudAction<BaseIdentityRelation> {
	...
	@Override
	public void delete() {
		this.relationSrv.updateALumniIdentity(id, AlumniIdentityEnum.COLLEGE_KEY_ALUMNI.getValue());
		sendSuccessMsg();
	}
