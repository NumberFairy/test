...
public class AlumnusChangePasswordAction extends AlumniBaseAction<PublicUser> {
	public AlumnusChangePasswordAction(@Qualifier(value = "publicUserSrv") IBaseSrv<PublicUser> baseSrv) {
		super(baseSrv);
	}
