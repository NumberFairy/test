...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <%@include file="/WEB-INF/jsp/common/header.jsp"%>
                            ...
                            <div class="ibox-content">
                                <div class="m-t">
                                    <form class="form-horizontal" id="form-all">
                                        <div class="clearfix">
                                            <div class="col-sm-6">
                                                <input type="hidden" id="entityId" name="entity.alumni.id" value="${entity.alumni.id}">
                                                <input type="hidden" id="entityAlumniId" name="entity.alumniId" value="${entity.alumniId}">
        ...
        <%@ include file="/WEB-INF/jsp/common/js-container.jsp"%>
            <script type="text/javascript" src="${contentPath}/resources/js/alumni-manage-center/liaison-manage/create.js"></script>
            <script>
