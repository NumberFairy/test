    ...
    <%@include file="/WEB-INF/jsp/common/header.jsp"%>
        ...
        <%@ include file="/WEB-INF/jsp/common/js-container.jsp"%>
            <%@ include file="/WEB-INF/jsp/alumni-manage-center/model.jsp"%>
                <script type="text/javascript" src="${contentPath}/resources/js/alumni-manage-center/unversity-core-alumni/page.js"></script>
                <script type="text/html" id="gridTpl">
                    {{each results as value index}}
                    <tr id="{{value.id}}">
                        <td class="bs-checkbox" style="width:36px;">
                            <input type="checkbox" class="child" value="{{value.id}}" data-alumniId={{value.alumniId}}>
                        </td>
