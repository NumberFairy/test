                            ...
                            <div class="ibox-content">
                                <form id="form" class="form-horizontal clearfix">
                                    <div class="input-group col-sm-4">
                                        <input id="search-value" name="entity.title" placeholder="请输入图片名称" type="text" class="form-control">
                                ...
                                <div class="clearfix">
                                    <div class="pull-left">
                                        <a href="/home-news-pic!hrefAddOrUpdate" class="btn btn-sm btn-info marl">新 增</a>
        ...
        <%@ include file="/WEB-INF/jsp/common/js-container.jsp"%>
            <script type="text/html" id="gridTpl">
                ...
                <tr id="{{value.id}}">
                    ...
                    {{if !value.picState||value.picState==0}}
                    <td>否</td>
                    {{else}}
                    <td>是</td>
                    {{/if}}
            ...
            <script type="text/javascript" src="${contentPath}/resources/js/gateway-menu-manage/cycle-pic/page.js"></script>
